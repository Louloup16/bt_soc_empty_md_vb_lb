...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x21, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x0e, .char_uuid = 0x000c } },
  { .handle = 0x22, .uuid = 0x000c, .permissions = 0x807, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
